...
class ColorsApp {
  ...
  static const Color info = Color(0xffC5CFDA);
  static const Color success = Color(0xff77C19A);
  static const Color control = Color(0xff8C92A2);
  ...
  static const Color basic = Color(0xffBBDECC);ss
}
