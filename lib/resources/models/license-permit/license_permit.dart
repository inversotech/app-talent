...
LicensePermitModel licensePermitModelFromJson(String str) =>
    LicensePermitModel.fromJson(json.decode(str));

String licensePermitModelToJson(LicensePermitModel data) =>
...
class LicensePermitModel {
  ...
  factory LicensePermitModel.fromJson(Map<String, dynamic> json) =>
      LicensePermitModel(
          ...
          goce: json["goce"],
          nombresGrupo: json["nombres_grupo"]);
